 ...
 * @param {float} v Value being pushed onto the array
 * @param {array} vArray The array which is being inserted into
 * @return {void} none
 */
...
/**
 * Subdivides a particular triangle for the sphere
 * @param {int} a one vertex of the triangle
 * @param {int} b one vertex of the triangle
 * @param {int} c one vertex of the triangle
 * @param {array} vertexArray The resulting array of vertices
 * @param {array} normalArray The resulting array of vertex normals
 * @return {int} numT The number of triangles generated
 */
...
/**
 * Creates a sphere by subdividing
 * @param {int} numSubDivs The number of subdivisions to perform
 * @param {array} vertexArray The resulting array of vertices
 * @param {array} normalArray The resulting array of vertex normals
 * @return {int} numT The number of triangles generated
 */
